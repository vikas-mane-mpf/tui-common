define(['underscore', 'jquery', 'backbone',
        ...
        'common/collections/DeliveryPlatformCollection',
        'common/collections/AgencyCollection',
        'common/collections/CoreAgencyCollection',
        'common/collections/GeoCollection',
        'common/collections/AdvertiserCollection',
        'common/collections/TPAccountsCollection',
        'common/models/TPAccountsModel',
        'common/collections/ModelReportingCollection',
        'common/events/EventDispatcher'],
function(_, $, Backbone,
		RemoteService, 
        AccountService,
        CacheService,
