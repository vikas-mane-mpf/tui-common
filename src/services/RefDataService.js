define(['underscore', 'jquery', 'backbone',
        ...
        'main/collections/DeliveryPlatformCollection',
        'main/collections/AgencyCollection',
        'main/collections/CoreAgencyCollection',
        'main/collections/GeoCollection',
        'main/collections/AdvertiserCollection',
        'main/collections/TPAccountsCollection',
        'main/models/TPAccountsModel',
        'main/collections/ModelReportingCollection',
        'main/events/EventDispatcher'],
function(_, $, Backbone,
		RemoteService, 
        AccountService,
        CacheService,
